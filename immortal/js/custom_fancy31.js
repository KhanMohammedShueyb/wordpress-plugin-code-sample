 ...
 function calculate_addition(clicked_id){
		...
		if(clicked_id == 'rush_my_order'){
			if (jQuery('#'+clicked_id).val() == "on") {
				 ...
				 jQuery('#'+clicked_id+'_input').val("off");
				  ...
				  jQuery('#'+clicked_id).text('RUSH MY ORDER');
			  ...
			  jQuery('#'+clicked_id).text('No RUSH');
			  rush_my_order = 'on';
		...
		if(clicked_id == 'i_want_stream'){
			if (jQuery('#'+clicked_id).val() == "on") {
			      ...
			      jQuery('#'+clicked_id).removeClass("off");
			      jQuery('#'+clicked_id).addClass("off");
			      jQuery('#'+clicked_id).text('I WANT STREAM');
			  ...
			  jQuery('#'+clicked_id).removeClass("off");
			  jQuery('#'+clicked_id).addClass("on");
			  jQuery('#'+clicked_id).text('NO STREAM');
			  /* mmr_price calculation */
				mmr_price_additional = jQuery('#mmr_price_additional').val();
				additional_value = 5;
				mmr_price_additional_iws = parseFloat(mmr_price_additional) + parseFloat(additional_value);
		...
		if(clicked_id == 'i_choose_heros'){
			if (jQuery('#'+clicked_id).val() == "on") {
			      ...
			      jQuery('#'+clicked_id).removeClass("off");
			      jQuery('#'+clicked_id).addClass("off");
			      jQuery('#'+clicked_id).text('I CHOOSE HEROES');
				   /* mmr_price calculation */
			      ...
			      jQuery('#'+clicked_id).removeClass("off");
			      jQuery('#'+clicked_id).addClass("on");
			      jQuery('#'+clicked_id).text('ANY HEROES');
				   /* mmr_price calculation */
					mmr_price_additional = jQuery('#mmr_price_additional').val();
					mmr_price_base = jQuery('#mmr_price_base').val();
					additional_value = parseFloat(mmr_price_base) * 0.20 ;
		...
		if(clicked_id == 'schedule_time'){
			if (jQuery('#'+clicked_id).val() == "on") {
			      ...
			      jQuery('#'+clicked_id).text('I WANT SELFPLAY');
				   /* mmr_price calculation */
					mmr_price_additional = jQuery('#mmr_price_additional').val();
					mmr_price_base = jQuery('#mmr_price_base').val();
			      ...
			      jQuery('#'+clicked_id).removeClass("off");
			      jQuery('#'+clicked_id).addClass("on");
			      jQuery('#'+clicked_id).text('TURN OFF SELFPLAY');
				   /* mmr_price calculation */
					mmr_price_additional = jQuery('#mmr_price_additional').val();
					mmr_price_base = jQuery('#mmr_price_base').val();
					additional_value = parseFloat(mmr_price_base) * 0.50 ;
		...
		mmr_price_base = jQuery('#mmr_price_base').val();
		mmr_price_additional = jQuery('#mmr_price_additional').val();
		mmr_price_additional_rush = jQuery('#mmr_price_additional_rush').val();
		mmr_price = parseFloat(mmr_price_base) + parseFloat(mmr_price_additional)+ parseFloat(mmr_price_additional_rush);
...
function base_price_calculation(game_type){
	...
	var range_value = [];
	var range_price = [];
	var ranges = [105,2500, 3500, 4500, 5000, 5500, 5800, 6200];
	var from = 1;
	var to = ranges[0];
	var rush_range_prices = [5,0.8,0.8,0.8,2.8,5.25,9.1,14];
	var range_prices = [5,1.5, 2, 3.5, 4.5, 7, 9, 12];
	...
	var estimted_days = [1,1, 1, 1, 2, 2, 3, 4];
...
function rush_my_order_calculation(rush_my_order){
	...
	var from = 1;
	var to = ranges[0];
	var range_prices = [0,0.75,0.75,0.75,2,3, 6, 10];
...
38€ per 35 Points */
		...
		mmr_price_additional = jQuery('#mmr_price_additional').val();
		mmr_price_additional_rush = jQuery('#mmr_price_additional_rush').val();
		mmr_price = parseFloat(base_price) + parseFloat(mmr_price_additional) + parseFloat(mmr_price_additional_rush);
